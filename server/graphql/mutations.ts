...
import { Artist, AddArtistInput, EditArtistInput } from "./types/artist.type";
  ...
  fields: {
    ...
    addNews: {
      ...
      resolve: (root: any, args: any, context: any, info: any) => {
          ...
          const news = new NewsModel({ ...args.news, createdAt });
          return news.save();
      },
    },
    updateNews: {
    ...
    deleteNews: {
      ...
      resolve: async (root: any, args: any, context: any, info: any) => {
        const news = await NewsModel.findByIdAndDelete(args.id);
        return news;
      },
    },
